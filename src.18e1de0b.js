...
},{}],"src/drivers/audioDriver.ts":[function(require,module,exports) {
"use strict";
...
var makeAudioDriver = exports.makeAudioDriver = function makeAudioDriver(createAudioContext) {
    return function (action$) {
        var audioCtx$ = action$.filter((0, _utils.ofType)("start_recording")).map(createAudioContext);
        var mediaSource$ = audioCtx$.map(createUserMediaSource);
        var playbackSource$ = audioCtx$.map(createPlaybackSource);
        var source$ = _xstream2.default.combine(mediaSource$, playbackSource$);
        var volume$ = action$.filter((0, _utils.ofType)("set_volume")).map(function (action) {
            return action.data;
        });
        _xstream2.default.combine(playbackSource$, volume$).subscribe({
            next: function next(_a) {
                var playbackSource = _a[0],
                    volume = _a[1];
                playbackSource.setVolume(volume);
            }
        });
        _xstream2.default.combine(action$, source$).subscribe({
            next: function next(_a) {
                var action = _a[0],
                    _b = _a[1],
                    mediaSource = _b[0],
        ...
        return {
            ...
            sourceAnalyser: mediaSource$.map(function (mediaSource) {
                return mediaSource.analyser;
            }),
            outputAnalyser: playbackSource$.map(function (playbackSource) {
                return playbackSource.analyser;
            })
        };
    };
};
},{"xstream":"node_modules/xstream/index.js","../utils":"src/utils.ts"}],"src/components/LabeledSlider.ts":[function(require,module,exports) {
"use strict";
...
var main = function main(sources) {
    ...
    var toggleButtonProps$ = _xstream2.default.of(false).map(function (value) {
        return {
    ...
    .map(function () {
        return _xstream2.default.combine(sources.audio.sampleRate, threshold$).take(1).map(function (_a) {
            var sampleRate = _a[0],
                threshold = _a[1];
            return {
                key: "start",
...
//# sourceMappingURL=/src.18e1de0b.map