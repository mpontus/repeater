...
var ctx = self;
var THRESHOLD = 200;
var lengthInSeconds = 60;
var sampleRate = 44100;
var buffer = new Float32Array(lengthInSeconds * sampleRate); // 44100 * seconds
var offset = 0;
var recordingStarted = false;
var isHearingVoice = function isHearingVoice(samples) {
...
ctx.onmessage = function (e) {
    ...
    var loudEnough = isHearingVoice(pcm);
    if (!recordingStarted) {
        if (loudEnough) {
