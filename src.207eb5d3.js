...
},{"xstream":"node_modules/xstream/index.js","@cycle/dom":"node_modules/@cycle/dom/lib/es6/index.js"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var main = function main(sources) {
    ...
    var toggleButtonProps$ = sources.storage.local.getItem("started").take(1).map(function (value) {
        ...
        return {
            label: (0, _dom.svg)({ attrs: { viewBox: "0 0 24 24" } }, [_dom.svg.path({
                attrs: {
    ...
    var vdom$ = _xstream2.default.combine(volumeSlider.DOM, thresholdSlider.DOM, toggleButton.DOM).map(function (_a) {
        var volumeSliderDOM = _a[0],
            thresholdSliderDOM = _a[1],
            toggleButtonDOM = _a[2];
        return (0, _dom.div)([volumeSliderDOM, thresholdSliderDOM, toggleButtonDOM]);
    });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '35913' + '/');
...
//# sourceMappingURL=/src.207eb5d3.map